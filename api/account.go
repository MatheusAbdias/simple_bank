...
type addAccountBalanceDTO struct {
	Amount int64 `binding:"required,min=1" json:"amount"`
}

func (server *Server) updateAccount(ctx *gin.Context) {
	var req addAccountBalanceDTO
	var reqAccount getAccountDTO
	...
	arg := db.AddAccountBalanceParams{ID: reqAccount.ID, Amount: req.Amount}
